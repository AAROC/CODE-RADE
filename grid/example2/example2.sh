#!/bin/bash
# CODE-RADE Grid Example 2
# Author    : Bruce Becker
#           : https://github.com/brucellino
#           : CSIR Meraka
# Arguments :
#           : $1 - the name of the repo to use
# ########################################
# See the README.md in the repo
# This script demonstrates how to use the CODE-RADE modulefiles
# See `modules.sh` in the repo top-level directory
# ########################################

# We give some verbose context to the user -
# First - load the site module configuration
. /etc/profile.d/modules.sh


# Remember this from example 1?
