...
#export LST_TRANS_TRN_ORIG=$DIR_ROOT/asr_template/experiment_template/trans_trn.lst
#export LST_TRANS_TST_ORIG=$DIR_ROOT/asr_template/experiment_template/trans_tst.lst
...
export AUDIO_CMEANMASK="*/audio/???/%%%_*.wav"
...
export MFCC_CMEANMASK="*/mfccs/%%%_*.mfc"
