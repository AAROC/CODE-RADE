...
<etc>
```
3. Now `module add <your favourite application>`
4. What are you waiting for, go SCIENCE ! :tada:
...
[![Stories in Backlog](https://badge.waffle.io/AAROC/CODE-RADE.png?label=Backlog&title=Backlog)](https://waffle.io/AAROC/CODE-RADE)
